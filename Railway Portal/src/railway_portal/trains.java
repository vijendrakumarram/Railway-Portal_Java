...
import java.sql.*;
public class trains implements WindowListener,ActionListener {
    ...
    trains()
    {
      ...
      Color c1=new Color(20,100,80);
      f.setBackground(c1);  
      
     //label
     lbl1=new Label("Train No");
     lbl2=new Label("Train Name");
     lbl3=new Label("Available Seat");
     lbl4=new Label("Date");
     ...
     lbl2.setBounds(70,180,67,35);
     lbl3.setBounds(70,280,81,35);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==btn1)
        {
                ...
                ResultSet rs=stmt.executeQuery();
                 ...
                 {
                     JOptionPane.showMessageDialog(null,"Please Enter Correct Train No...");
                 }
